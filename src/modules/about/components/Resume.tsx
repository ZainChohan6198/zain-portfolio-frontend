...
const Resume = () => {
  const RESUME_URL = 'http://bit.ly/4qstKVz';
  ...
  return (
    <div className='space-y-5'>
      ...
      <GoogleDocsEmbed src='https://docs.google.com/document/d/1536LlQyeir5IJHB1ZEq95PAKL6JmWgdExsDVRdyKc1Q/edit?usp=sharing' />
    </div>
  );
};
