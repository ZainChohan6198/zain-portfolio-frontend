...
export const STACKS = {
  ...
  MUI: <SiMui size={iconSize} className='text-blue-500' />,
  'Material Ui': (
  ...
  Maps: <SiGooglemaps size={iconSize} className='text-green-500' />,
  'Google Maps': <SiGooglemaps size={iconSize} className='text-green-500' />,
  OpenStreetMap: <SiOpenstreetmap size={iconSize} className='text-green-600' />,
  'Open Street Maps': <SiOpenstreetmap size={iconSize} className='text-green-600' />,
