...
export const SOCIAL_MEDIA: MenuItemProps[] = [
  {
    title: 'Email',
    href: 'mailto:zain.chohan10@gmail.com',
  ...
  // {
  //   title: 'Twitter',
  //   href: 'https://twitter.com/zainchohan6198',
